...
<div class='modal fade' id='VentaSeleccionarFacturaClienteModal' tabindex='-1' role='dialog' aria-labelledby='myLargeModalLabel' aria-hidden='true'>
        ...
        <div class="table-responsive">
          <table class="table dataTable" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody id="tableBodyViewClients">     
              ...
              <?php
                //se incluye la tabla
                require_once("VentaFacturaModalSeleccionarClienteTable.php"); 
              ?>
            </tbody>
          </table>
        </div>
