...
foreach ( $result as $row ) {   
  ...
  $output .= "<td><input type='number' onchange='NotaDebitoCalcularTotal()' step='0.1' class='form-control' required='required' style='border:0' value=" . $cantidad . "></td>";
  $output .= '<td>' . $unidad . "</td>";
  $output .= "<td><input type='number' onchange='NotaDebitoCalcularTotal()' step='0.1' class='form-control' required='required' style='border:0' value=" . $precioVenta . "></td>";
