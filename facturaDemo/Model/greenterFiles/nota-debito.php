...
$invoice = (new Note())
    ...
    ->setTipoDoc('08')//08 de nota de debito
    ->setSerie($NotaDebitoSerie)
    ->setCorrelativo($NotaDebitoCorrelativo)

    ->setTipDocAfectado($tipoDoc)
    ->setNumDocfectado($serie.'-'.$correlativo)
    ->setCodMotivo($NotaDebitoTipo)
    ->setDesMotivo($descripcionNotaDebito)
