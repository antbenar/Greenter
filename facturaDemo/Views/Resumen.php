  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        ...
        <button type="button" class="btn btn-danger" data-toggle="modal" onclick="iniciarResumen()" > <i class="fas fa-download fa-sm text-white-50"></i>Nuevo Resumen Diario</button>
      </div>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger">Listado de los Resúmenes Diarios</h6>
            </div>
            <div class="card-body">
